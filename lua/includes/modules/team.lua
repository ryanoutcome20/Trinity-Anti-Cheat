...
function GetAllTeams()
    ...
    if ( CLIENT && _G.TAC_Capture_Stack ) then
        TAC_Capture_Stack( "team.GetAllTeams" )
    end
...
function GetClass( id )
    ...
    if ( CLIENT && _G.TAC_Capture_Stack ) then
        TAC_Capture_Stack( "team.GetClass" )
    end
...
function GetPlayers( index )
    ...
    if ( CLIENT && _G.TAC_Capture_Stack ) then
        TAC_Capture_Stack( "team.GetPlayers" )
    end
